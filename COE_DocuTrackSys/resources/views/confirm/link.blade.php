...
<body>
    <div class="wrapper" style="text-align: justify;">
        ...
        <h2 style="text-align: center;">Email Linked to for System Storage</h2>
    
        <div class="mb-2">
            Your Google account's Google Drive is successfully linked. It can now be used to store uploaded documents and reports. You can now close this tab.
        </div>
    </div>
</body>
</html>