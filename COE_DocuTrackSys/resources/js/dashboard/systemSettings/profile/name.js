...
$('.profileNameBtn').on('click', '#editNameBtn', function(event){
    ...
    $('.profileNameBtn').html(`
        <button class="btn btn-primary editProfile" id="resetNameBtn" data-value="${profileName}"><i class='bx bx-x' style="font-size: 20px;"></i></button>
    `);
});
...
$('.profileNameBtn').on('click', '#resetNameBtn', function(event){
    ...
    $('.profileNameBtn').html(`
        <button class="btn btn-primary editProfile" id="editNameBtn" data-value="${profileName}"><i class='bx bx-edit-alt' style="font-size: 20px;"></i></button>
    `);
